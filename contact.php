    ...
    <section class="p-t-b-150"> 
      ...
      <div class="container"> 
        ...
        <div class="heading-block">
          <h4>CONTACT US</h4>
          <hr>
          <span>Connect with us through email or by mobile number.</span> </div>
        <div class="contact">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <ul class="row">
                    ...
                    <li class="col-sm-12">
                      <label>
                        <textarea class="form-control" name="message" id="message" rows="5" placeholder="Vernacular is accepted as long as it is appropriate."></textarea>
                      </label>
                    </li>
