        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">Clinic Management System</div>
          ...
          <div role="tabpanel">
            <div class="dep-sec-nav"> 
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a href="#brylle" role="tab" data-toggle="tab">barcoma </a></li>
                <li role="presentation"><a href="#artizuela" role="tab" data-toggle="tab">artizuela </a></li>
                <li role="presentation"><a href="#badian" role="tab" data-toggle="tab">badian </a></li>
                <li role="presentation"><a href="#menor" role="tab" data-toggle="tab">menor </a></li>
                <li role="presentation" class="active"><a href="#adviser" role="tab" data-toggle="tab"> adviser </a></li>
              </ul>
            </div>
            ...
            <div class="tab-content"> 
              ...
              <!-- brylle -->
              <div role="tabpanel" class="tab-pane fade" id="brylle"> 
              ...
              <!-- artizuela -->
              <div role="tabpanel" class="tab-pane fade" id="artizuela"> 
                <!-- Depatment Text Section -->
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
              ...
              <!-- badian -->
              <div role="tabpanel" class="tab-pane fade" id="badian"> 
                <!-- Depatment Text Section -->
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
              ...
              <!-- menor -->
              <div role="tabpanel" class="tab-pane fade" id="menor"> 
                <!-- Depatment Text Section -->
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
              ...
              <!-- adviser -->
              <div role="tabpanel" class="tab-pane fade in active" id="adviser"> 
                <!-- Depatment Text Section -->
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
